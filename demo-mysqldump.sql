...
INSERT INTO `comment` VALUES (1,3,1,1,'TCCCCCCCCCCCCCCCCC',1397328432,1397328432,0);
...
INSERT INTO `module` VALUES (1,NULL,'module-1','',1,0),(2,1,'submodule-1-1','description for submodule-1-1',0,1),(3,1,'submodule-1-2','description for submodule-1-2',0,0),(4,NULL,'module-2','',1,0),(5,4,'submodule-2-1','description for submodule-2-1',0,0),(6,4,'submodule-2-2','description for submodule-2-2',0,0);
...
INSERT INTO `role` VALUES (1,'admin','ROLE_ADMIN'),(2,'user','ROLE_USER'),(3,'super_admin','ROLE_SUPER_ADMIN');
...
INSERT INTO `thread` VALUES (1,3,2,1,1,'TTTTTTTTTTTTTTTTTTTT','TCCCCCCCCCCCCCCCCC',0,0,0,1,1397328432,1397328432,'testsuperadmin');
...
INSERT INTO `thread_track` VALUES (3,1,2,1,0,1397328451);
...
CREATE TABLE `user` (
  ...
  `credentials_expire_at` int(10) unsigned DEFAULT NULL,
  `is_locked` tinyint(1) NOT NULL,
  `is_expired` tinyint(1) NOT NULL,
  `last_signin_at` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `user` VALUES (1,'testuser','$2y$13$m2iFu4p1qasjhgOErUGesOMjHMje7Ky67tFYmwmwfYQoAs6kLGOky','testuser@email.com',1,0,0,NULL,0,0,NULL),(2,'testadmin','$2y$13$ULIZIu1LVAv67Me6CVB3we8CDjg05sedNTNT6ftxG.YvpXWZ9Gxv.','testadmin@email.com',1,0,0,NULL,0,0,NULL),(3,'testsuperadmin','$2y$13$A6DrB4YFzydNhRNEXmWl.Ohf1eF4O/.hrZF3V5WuLYlEnL2q.SASO','testsuperadmin@email.com',1,0,0,NULL,0,0,1397327777);
...
INSERT INTO `user_role` VALUES (2,1),(1,2),(3,3);
...
-- Dump completed on 2014-04-12 13:01:41
